...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Tambah Obat Dinas
                        <div style="float:right;" class="">
                            <a href="{{ URL::to('dinas_obat') }}" class="btn btn-warning"><i class="splashy-zoom"></i> List Obat</a>
                        </div>
                    </h3>
                ...
                {{ Form::open(array('id'=>'reg1_form', 'class' => 'form-horizontal','url'=> URL::to('dinas_obat') )) }}
