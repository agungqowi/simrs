			...
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
        				...
        				<li>
        					<a href="{{ url('dinas_transaksi') }}">Transaksi</a>
        				</li>
        				<li>
        					List
        				</li>
	        	...
	        	<div class="span12">
	        		<h3 class="heading">Daftar Transaksi
                        <div style="float:right;" class="">
                            <a href="{{ URL::to('dinas_transaksi/create') }}" class="btn btn-success"><i class="splashy-contact_grey_add"></i> Tambah Transaksi Baru</a>
                        </div>
                    </h3>
	        	</div>
            </div>
