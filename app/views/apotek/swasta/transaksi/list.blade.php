...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
        				...
        				<li>
        					<a href="{{ url('swasta_transaksi') }}">Transaksi</a>
        				</li>
        				<li>
        					List
        				</li>
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Daftar Transaksi
                        <div style="float:right;" class="">
                            <a href="{{ URL::to('swasta_transaksi/create') }}" class="btn btn-success"><i class="splashy-contact_grey_add"></i> Tambah Transaksi Baru</a>
                        </div>
                    </h3>
	        	</div>
            </div>
