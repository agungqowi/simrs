			...
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
        				...
        				<li>
        					<a href="{{ url('apotek_obat/'.$slug) }}">Obat</a>
        				</li>
        				<li>
        					List
        				</li>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <table id="tbl_obat" class="table table-striped table-bordered table-hover">
                        ...
                        <thead>
                            <tr>
                                <th align="center" valign="middle" class="head1">ID Obat / Gudang</th>
                        ...
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
									...
									<input type="hidden" id="id_obat_gudang_old" name="id_obat_gudang_old" class="span12 no-primary">
                                </div>
                            </div>
                            <div class="control-group">
