...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Pendaftaran IGD
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <button type="button" id="btn_pasien_rawat" class="btn btn-primary no-primary"><i class="splashy-check"></i> Registrasi IGD</button>
                    ...
                    {{ Form::open(array('action' => 'UgdController@store' , 'id'=>'reg2_form', 'class' => 'form-horizontal' , 'style' => 'display:none')) }}
                        ...
                        <div class="span7"> 
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select data-placeholder="Pilih Dokter" id="cmb2_dokter" name="cmb2_dokter" class="chzn_a">
                                        <option>-</option>
                                        @foreach($dokter as $u => $s)
                                            <option value="{{ $s->IdDokter }}">
                                                {{ $s->NamaDokter }} 
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select id="cmb_cara_bayar" name="cmb_cara_bayar" class="no-primary">
                                        ...
                                        <option>BPJS</option>
                                        <option>Umum</option>
                                        <option>Asuransi Swasta</opt<option value="">-</option>
                                        <option>BPJS</option>
                                        <option>Umum</option>
                                        @if(isset($rekanan) && count($rekanan) > 0)
                                            @foreach($rekanan as $r)
                            ...
                            <div>
                                <div class="controls">                                
                                    ...
                                    <a href="{{ url('ugd/register') }}" disabled="disabled" id="btn_baru" class="btn btn-warning">Tambah baru</a>
                                </div>
                            </div>
                            ...
                            <div class="control-group formSep">
                                <div class="controls">
                                    ...
                                    <button type="button" id="btn_cetak3"  disabled="disabled" class="btn btn-success no-primary"><i class="splashy-printer"></i> Cetak Struk</button>
                                </div>
                            </div>
