			...
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
                        ...
                        <li>
                            <a href="{{ action('DashboardController@index') }}">Gudang</a>
                        </li>
                        <li>
                            <a href="{{ url('gudang_obat/'.$slug) }}">{{ $title }}</a>
                        </li>
        				<li>
        					<a href="{{ url('gudang_obat/'.$slug) }}">Obat</a>
        				</li>
        				<li>
        					List
        				</li>
                    ...
                    <table id="tbl_obat" class="table table-striped table-bordered table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th align="center" valign="middle" class="head2">Kode Gudang</th>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function(){
                            oTable = $('#tbl_obat').dataTable({
                                ...
                                "bProcessing": false,
                                "sAjaxSource": "{{ url('gudang_obat/datatable/'.$slug) }}",
                                "bServerSide": true,
                                "aoColumnDefs" : [
                                    {
                                        "aTargets" : [ 5 ],
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function edit_data(id_obat,nama_obat,kode_obat,jenis_obat,komposisi,satuan,masa,harga,harga_beli,stok){
        ...
        function ubah_data(){
			...
			$.ajax({
				url: "{{ url('gudang_obat/editdatatable/'.$slug) }}",
				type: "POST",
				data : "&id_obat="+id_obat+"&harga="+harga+"&nama_obat="+nama_obat+"&harga_beli="+harga_beli+
