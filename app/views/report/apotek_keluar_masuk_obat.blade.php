    ...
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('report/keluar_masuk_obat/'.$slug) }}">Keluar Masuk Obat</a>
                        </li>
                        <li>
                            Apotek {{ $title }}
                        </li>
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="heading">Laporan Keluar Masuk Obat Apotek {{ $title }}
                        </h3>
                        ...
                        <br />
                        {{ Form::open(array('url' => 'report/keluar_masuk_obat_view/'.$slug ,'method' => 'POST' , 'id'=>'reg1_form', 'class' => 'form-horizontal')) }}
                        <div class="row-fluid formSep">
                            <div class="span6"> 
                                ...
                                <div class="control-group">
                                    <label class="control-label">Pilihan Transasksi</label>
                                    <div class="controls">
                                        <select name="pilihan_transaksi" id="pilihan_transaksi">
                                            <option value="1">Transaksi Obat Masuk</option>
                                            <option value="2">Transaksi Obat Keluar</option>
                                            <option value="3">Semua Transaksi</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
