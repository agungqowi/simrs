                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <span style="float:right;">
                            <a href="{{ url('report/jasa_dokter_print/rawat_jalan') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
                                <i class="splashy-printer"></i> Cetak
                            </a>
                            <a href="{{ url('report/jasa_dokter_excel/rawat_jalan/xls') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
                                <i class="splashy-calendar_week_add"></i> Excel 2003
                            </a>
                            <a href="{{ url('report/jasa_dokter_excel/rawat_jalan/xlsx') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
							   ...
							   <table id="tbl_pasien" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td><a onclick="detail_jasa('{{ $ja->NoRegJalan }}')" href="javascript:void(0)"><i class="splashy-zoom"></i></a></td>
										</tr>
										@endforeach
									</tbody>
								</table>
...
@section('js')
    ...
    <script type="text/javascript">
		...
		function detail_jasa(noreg){
			window.open("{{ url('report/jasa_dokter_detail/rawat_jalan') }}/"+noreg, "_blank");
		}
    </script>
@stop
