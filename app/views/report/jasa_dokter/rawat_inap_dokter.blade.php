    ...
    <div id="contentwrapper">
        <div class="main_content">
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="heading">Laporan Jasa Dokter Rawat Inap
                        </h3>
                        <div class="row-fluid">
                            <div class="span12">
                        ...
                        <br />
                        {{ Form::open(array('url' => 'report/jasa_dokter_view/rawat_inap_dokter' ,'method' => 'POST' , 'id'=>'reg1_form', 'class' => 'form-horizontal')) }}
