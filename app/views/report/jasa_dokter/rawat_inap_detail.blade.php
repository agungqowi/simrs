...
@section('content')
    <div id="contentwrapper">
        <div class="main_content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="heading">Detail Laporan Jasa Dokter Rawat Inap
                    ...
                    <div class="row-fluid" id="printarea">
						...
						<div class="row-fluid">
							<div class="span12">
								<table width="100%">
									<tr>
										<td width="11%"><b>Dari Tanggal</b></td>
										<td><b>:</b></td>
										<td><b>{{ $mulai }}</b></td>
									</tr>
									<tr>
                    ...
                    @if(isset($registrasi))
                            ...
                            <table width="100%" border="0" align="center">
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        Ruangan/ Kls/ No Kamar
                                    </td>
                                    <td width="30%">: 
                                        @if(isset($registrasi->Ruangan ))
                                           {{ $registrasi->Ruangan.'/ '.$registrasi->Kelas.'/ '.$registrasi->NoKamar  }}
                                        @endif
                                    </td>
                                </tr>
                                <tr>
