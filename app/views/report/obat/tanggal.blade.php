    ...
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('report/keluar_masuk_obat/'.$slug) }}">{{ $judul }}</a>
                        </li>
                        <li>
                            {{ $title }}
                        </li>
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="heading">Laporan {{ $judul }} {{ $title }}
                        </h3>
                        ...
                        <br />
                        {{ Form::open(array('url' => 'report/'.$target.'/'.$slug ,'method' => 'POST' , 'id'=>'reg1_form', 'class' => 'form-horizontal')) }}
                        <div class="row-fluid formSep">
                            <div class="span6"> 
                                ...
                                @if( $target == 'penjualan_perobat_view' )
                                    <div class="control-group">
                                        <label class="control-label">Obat</label>
                                        <div class="controls">
                                            <select name="obat" id="obat" class="select2">
                                            <?php $obat     = DB::table('apo_obat')->get(); ?>
