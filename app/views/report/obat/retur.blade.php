    ...
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('report/keluar_masuk_obat/'.$slug) }}">Retur Obat</a>
                        </li>
                        <li>
                            {{ $title }}
                        </li>
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="heading">Laporan Retur Obat {{ $title }}
                        </h3>
                        ...
                        <br />
                        {{ Form::open(array('url' => 'report/retur_obat_view/'.$slug ,'method' => 'POST' , 'id'=>'reg1_form', 'class' => 'form-horizontal')) }}
