...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
        				...
        				<li>
        					<a href="{{ action('DokterController@index') }}">Tindakan</a>
        				</li>
        				<li>
        					List
        				</li>
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Daftar Tindakan
                        <div style="float:right;" class="">
                            <a href="{{ URL::to('tindakan/create') }}" class="btn btn-success"><i class="splashy-contact_grey_add"></i> Tambah Tindakan Baru</a>
                        </div>
                    </h3>
	        	</div>
            </div>
            <div class="row-fluid">
                ...
                <?php $success = Session::get('success'); ?>
                    ...
                    @endif
                {{ Datatable::table()->addColumn('IdTindak','Tindakan','Gol','Kel','Tarif','Adm','Fas','Action')
                        ->setOptions('sPaginationType','bootstrap')
                        ->setUrl(URL::to('tindakan/datatable'))->render() }}
                </div>
	        </div>
	   	</div>
	</div>
    ...
    {{ Form::open(array('url' => 'tindakan/', 'id' => 'delete_form', 'class' => 'pull-right')) }}
        ...
        <input type="hidden" id="url_delete" value="{{ url('tindakan') }}">
