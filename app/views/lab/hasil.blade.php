                   		...
                   		<div class="span12">
                   			<div class="tabbable">
								<ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#hasiltab" data-toggle="tab">Hasil Lab</a></li>
                                    ...
                                    <div class="tab-pane" id="hasiltab">
                                        ...
                                        <div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select id="kategori_pemeriksaan">
                                                        <option value="">-</option>
                                                            @foreach($lab_kategori as $k)
                                                                <option value="{{ $k->id }}">{{ $k->nama_kategori }}</option>
                                                            @endforeach
                                                    </select>
                                                    <input type="button" id="btn_kategori" class="btn btn-primary extra-fields" disabled="disabled" value="Tambah" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <span>Kesimpulan</span><br /><textarea class="span10" id="kesimpulan" name="kesimpulan"></textarea><br />
                                            <div class="clear"></div>
                                            <br />
