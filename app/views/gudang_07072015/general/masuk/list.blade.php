		...
		<div class="main_content">
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
        				...
        				<li>
        					<a href="{{ url('askes_transaksi') }}">Transaksi</a>
        				</li>
        				<li>
        					List
        				</li>
	        	...
	        	<div class="span12">
	        		<h3 class="heading">Daftar Transaksi
                        <div style="float:right;" class="">
                            <a href="{{ URL::to('askes_transaksi/create') }}" class="btn btn-success"><i class="splashy-contact_grey_add"></i> Tambah Transaksi Baru</a>
                        </div>
                    </h3>
	        	</div>
            </div>
            <div class="row-fluid">
                ...
                {{ Datatable::table()->addColumn('ID Obat','Nama Obat','Komposisi',
                        ...
                        ->setUrl(URL::to('askes_obat/datatable'))->render() }}
                </div>
	        </div>
	   	</div>
	</div>
