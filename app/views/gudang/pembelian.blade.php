...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Pembelian Barang
                    ...
                    <div class="row-fluid formSep">
                        <div class="span4">           
                            <div class="control-group">
                                <label class="control-label">Tanggal Pembelian<span class="f_req">*</span></label>
                                <div class="controls">
                                    <input type="text" name="tanggal_masuk" id="tanggal_masuk" class="nowdate span10">
                                </div>
                            </div>        
                            <div class="control-group">
                                <label class="control-label">Jenis Pembayaran<span class="f_req">*</span></label>
                                <div class="controls">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="harga_beli" name="harga_beli" class="span8" style="text-align: right">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="ppn" name="ppn" class="span8" style="text-align: right">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Diskon</label>
                                        <div class="controls">
                                            <input type="text" id="diskon" name="diskon" class="span8" style="text-align: right">
                                        </div>
                                    </div>
                                    <div class="control-group">
...
@section('js')
    ...
    <script type="text/javascript">
    	function hitungTotal(){
                ...
                var val = ( parseInt( jumlah ) * parseInt( harga_beli ) ) + parseInt(ppn) - parseInt(diskon);
                $('#total').val( val );
        }
        $(document).ready(function() {
...
*/
        ...
        function list_transaksi(){
            ...
            if(tanggal_masuk != ''){
                $.ajax({
                    url: "{{ url('gudang_pembelian/list_transaksi/') }}",
                    dataType: "json",
                    type: "POST",
                        ...
                        if(res == false){
                            ...
                            $.each(res, function (key, data) {
                                ...
                                $('#resep_list tbody').append('<tr>'+
                                        ...
                                        '<td class="align-right">'+data.ppn+'</td>'+
                                        '<td class="align-right">'+data.diskon+'</td>'+
        ...
        function tambah_transaksi(){
            ...
            $.ajax({
                url: "{{ url('gudang_pembelian/tambah_transaksi/'.$slug) }}",
                type: "POST",
        ...
        function hapus_transaksi(no,noba){
            ...
            if (r == true) {
                ...
                $('#pesan_error').hide();
                $.ajax({
                    url: "{{ url('gudang_pembelian/hapus_transaksi/'.$slug) }}",
                    type: "POST",
                    data : "no="+no,
                    success:function(res){
