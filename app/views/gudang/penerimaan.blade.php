                ...
                {{ Form::open(array('url' => url('gudang_penerimaan/belum/'.$id_pemesanan) , 'id'=>'reg1_form', 'class' => 'form-horizontal')) }}
                    ...
                    <div class="row-fluid formSep">
                        <div class="span8">
                            ...
                            <div class="control-group">
                                <label class="control-label">Nomor Faktur Penerimaan<span class="f_req">*</span></label>
                                <div class="controls">
                                    <input type="text" name="faktur_penerimaan" id="faktur_penerimaan" class=" span10">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        if(res == false){
                            ...
                            $.each(res, function (key, data) {
                                ...
                                $('#resep_list tbody').append('<tr>'+
                                        ...
                                        '</td><td>'+
                                        '<input type="nowdate" data-id="'+data.id_detail+'" style="max-width:100px;" '+_disabled+' name="expire['+data.id_detail+']" class="detail-expire" />'+
                                        '</td><td>'+
                                        '<input type="nowdate" data-id="'+data.id_detail+'" style="max-width:100px;" '+_disabled+' name="tempo['+data.id_detail+']" class="detail-tempo" />'+
                                        '</td><td>'+
                                        '<input type="text" data-id="'+data.id_detail+'" style="max-width:100px;" '+_disabled+' name="batch['+data.id_detail+']" class="detail-batch" />'+
                                        '</td><td>'+
                                        '<input type="text" data-id="'+data.id_detail+'" style="max-width:100px;" '+_disabled+' name="hargabeli['+data.id_detail+']" class="detail-harga" />'+                                  
                                        '</td><td></td></tr>');
                            });
