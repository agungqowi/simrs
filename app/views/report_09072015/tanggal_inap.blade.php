    ...
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ action('DashboardController@index') }}">Laporan</a>
                        </li>
                        <li>
                            <?php $loops = explode('_',$target); $target_title="";?>
                            @if(count($loops) > 1)
                                @foreach($loops as $l)
                                   <?php $target_title .= ucfirst($l).' '; ?>
                                @endforeach
                                {{ $target_title }}
                            @else
                                 {{ ucfirst( $target ) }}
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="heading">Laporan Rawat Inap :: {{ $target_title }}
                        </h3>
                        ...
                        <div class="row-fluid formSep">
                            <div class="span6"> 
                                ...
                                <input type="hidden" name="jenis_pelayanan" value="rawat_inap">
                                <div class="control-group">
                                    <div class="controls">
