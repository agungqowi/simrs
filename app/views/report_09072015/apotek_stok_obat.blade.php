    ...
    <div id="contentwrapper">
        <div class="main_content">
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="heading">Laporan Stok Obat Apotek {{ $title }}
                        ...
                        <div class="row-fluid" id="printarea">
                            <div class="span12">
                                ...
                                <br />
                                <h3>Laporan Stok Obat Apotek {{ $title }}</h3>
                                <br />
                                ...
                                <?php $loop++; ?>
								    <tr>
                                        ...
                                        <td>{{ $p->satuan }}</td>
                                        <td>{{ $p->namajenis }}</td>
                                        <td align="right">{{ $p->stok }}</td>
                                        <td align="right">{{ $p->harga }}</td>
                                    </tr>
                                @endforeach
                                    <tr style="background:#CCCCCC">
                                        <td colspan="7">Jumlah Obat : {{ number_format($loop) }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
