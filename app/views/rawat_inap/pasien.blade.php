                                        ...
                                        <table id="tindakan_list" class="table table-striped table-bordered">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="jam_tindakan" 
                                                        class="form-table-m extra-fields jam"  
                                                        id="jam_tindakan" disabled="disabled" />
                                                    </td>
                                                    <td>
                        ...
                        <div class="row-fluid">
                            <div class="span8">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="cara_pulang" id="cara_pulang" class="span12">
                                            <option value="-">Pilih</option>
                                            @if(count($cara_pulang))
                                                @foreach($cara_pulang as $c)
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="kondisi_pulang" id="kondisi_pulang" class="span12">
                                            <option value="-">Pilih</option>
                                            @if(count($kondisi_pulang))
                                                @foreach($kondisi_pulang as $k)
