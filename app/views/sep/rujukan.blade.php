    ...
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('sep/peserta/'.$slug) }}">Data Rujukan</a>
                        </li>
                        <li>
                            {{ $title }}
                        </li>
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="heading">Data Rujukan Berdasarkan {{ $title }}
                        </h3>
                        ...
                        <br />
                        {{ Form::open(array('url' => 'sep/rujukan_view/data/'.$slug ,'method' => 'POST' , 'id'=>'reg1_form', 'class' => 'form-horizontal')) }}
