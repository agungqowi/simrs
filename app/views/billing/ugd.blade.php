            ...
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('billing/ugd') }}">Pembayaran</a>
                        </li>
                        <li>
                            UGD
                        </li>
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <br />
                        {{ Form::open(array('url' => 'billing/ugd_view' ,'method' => 'POST' , 'id'=>'reg1_form', 'class' => 'form-horizontal')) }}
                        <div class="row-fluid formSep">
                            <div class="span6"> 
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <button disabled="disabled" type="submit" id="btn_pasien_ugd" class="btn btn-inverse no-primary"><i class="splashy-check"></i> Tampilkan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function(){
                                ...
                                oTable = jQuery('#tbl_pasien').dataTable({
                                    ...
                                    "bProcessing": false,
                                    "sAjaxSource": "{{ url('ugd/datatable_keluar' ) }}",
                                    "bServerSide": true
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function pilih_pasien(no_rm,id_reg,nama,tanggal){
            $('#no_rm').val(no_rm);
            $('#no_reg').val(id_reg);
            $('#txt_nama').val(nama);
            ...
            $('#btn_pasien_ugd').attr('disabled',false);
        }
    </script>
@stop
