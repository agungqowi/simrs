...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Ubah Cara Bayar Pasien Rawat jalan
                    </h3>
                ...
                <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="noreg" name="noreg" value="{{ $data->NoRegJalan }}" readonly class="span5">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="tanggal" name="tanggal" readonly class="span5" value="{{ $data->Tanggal }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" value="{{ $data->Poli }}" id="poli" name="poli" readonly class="span5">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select id="cmb_cara_bayar" name="cmb_cara_bayar" class="no-primary">
                                        <?php $ar_cara = DB::table('bill_penjamin')->get(); ?>
                                        <option value="">-</option>
                                        @foreach($ar_cara as $c)
                                            <?php $select = ""; ?>
                                            @if($c->Slug == $data->CaraBayar)
                                                <option selected="selected" value="{{ $c->Slug }}">{{ $c->Nama }}</option>
                                            @else 
                                                <option value="{{ $c->Slug }}">{{ $c->Nama }}</option>
                                            @endif
					...
					<input type="hidden" id="id_reg" name="id_reg" class="span10 no-primary" value="{{ $data->IdRegJalan }}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#reset').click(function(){
                window.location.href = '<?php echo url("/billing_carabayar"); ?>';
            });
        });
        ...
        function updateData(){
            ...
            if( cara_bayar2 == '' ){
                ...
                $.ajax({
                    url: "{{ url('billing_carabayar/rawat_jalan') }}",
                    type: "POST",
