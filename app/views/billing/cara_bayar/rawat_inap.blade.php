                ...
                <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="noreg" name="noreg" value="{{ $data->NoReg }}" readonly class="span5">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" value="{{ $data->Ruangan }}" id="Ruangan" name="Ruangan" readonly class="span5">
                                </div>
                            </div>
                        </div>
                    </div>
					...
					<input type="hidden" id="id_reg" name="id_reg" class="span10 no-primary" value="{{ $data->NoReg }}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#reset').click(function(){
                window.location.href = '<?php echo url("/billing_carabayar/rawat_inap"); ?>';
            });
        });
        ...
        function updateData(){
            ...
            if( cara_bayar2 == '' ){
                ...
                $.ajax({
                    url: "{{ url('billing_carabayar/rawat_inap') }}",
                    type: "POST",
