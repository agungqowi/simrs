                                ...
                                <div class="span12">
                                    ...
                                    @if(isset($admin))
                                        ...
                                        <table width="100%" border="1" colspan="2" class="report">
                                            <tr>
                                                <td width="10">
                                                    <input checked="checked" id="chk_admin" type="checkbox" name="chk_admin1" value="1">
                                                </td>
                                                <td align="center" width="15%">Tanggal</td>
                                                <td align="center" width="60%">Nama</td>
                                                ...
                                                <tr {{ $bgcolor }}>
                                                    <td width="10">
                                                        @if($t->StatusBayar == 0)
                                                            ...
                                                            class="check-all check-admin" name="chk_admin[]" value="{{ $t->Tarif }}">
                                                        @endif
                                                    </td>
