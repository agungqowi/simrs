...
@section('content')
    <div id="contentwrapper">
        <div class="main_content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="heading">Biaya Obat APS
                        <span style="float:right;">
                            <a href="{{ url('billing/obat_aps/'.$penjualan->id.'/semua') }}" target="_BLANK" class="btn btn-primary">
    ...
    <script type="text/javascript">
        ...
        function konfirmasiPembayaran(){
            ...
            if( pembayaran < total ){
                ...
                var _data = { 'obat[]' : [] , "id_reg" : id_reg ,"total_obat" : total_obat , "total" : total , "pembayaran" : pembayaran};
                ...
                if (r == true) {
                    $.ajax({
                        url: "{{ url('pembayaran/proses_obat') }}",
                        type: "POST",
                        data : _data,
