...
@section('content')
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('klaim_bpjs/rawat_inap') }}">Klaim BPJS</a>
                        </li>
                        <li>
                            Klaim Pasien BPJS
                        </li>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="heading">Input Klaim Pasien BPJS Rawat Inap
                    </h3>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <form action="{{ url('klaim_bpjs/rawat_inap_input') }}" method="get" class="form-horizontal" id="form_jasa">
