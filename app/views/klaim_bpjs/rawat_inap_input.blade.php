...
@section('content')
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('klaim_bpjs/rawat_inap') }}">Jasa Dokter</a>
                        </li>
                        <li>
                            Rawat Inap
                        </li>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="heading">Input Klaim BPJS Rawat Inap
                    </h3>
                                    ...
                                    <tr class="{{ $p->NoReg }} {{ $p->NoRM }} {{ $p->Nama }}">
                                        ...
                                        <td>
                                            @if($p->TotalKlaim=='' || empty($p->TotalKlaim))
                                                <?php $p->TotalKlaim = 0; ?>
                                            @endif
                                            <input style="width:80px" class="numeric total-klaim" data-noreg="{{ $p->NoReg }}" required type="text" style="width:100px" name="klaim['{{ $p->NoReg }}']" id="klaim_{{ $p->NoReg }}" value="{{ $p->TotalKlaim }}" />
                                        </td>
                                        <td>{{ $p->GolPasien }}</td>
                                        <td>
