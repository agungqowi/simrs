...
@section('content')
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('jasa_dokter/rawat_jalan') }}">Jasa Dokter</a>
                        </li>
                        <li>
                            Rawat Jalan
                        </li>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="heading">Pembagian Jasa Dokter | Rawat Jalan
                        <span style="float:right;">
                            <a href="{{ url('jasa_dokter/rawat_jalan_print/'.$registrasi->NoRegJalan) }}" target="_BLANK" class="btn btn-primary">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <?php 
                                        ...
                                        $jasa_medis_pengelola = 0.36;
                                        $jasa_operasional = 0.64;
