        ...
        <div class="main_content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <form action="{{ url('jasa_dokter/rawat_inap_klaim') }}" method="get" class="form-horizontal" id="form_jasa">
                                <div class="control-group">
                                    <label class="control-label">Dari Tanggal</label>
                                    <div class="controls">
                                        <div class="input-append date" id="dari">
                                            <input required class="span6" name="dari" type="text" readonly="readonly" /><span class="add-on"><i class="splashy-calendar_day_up"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append date" id="sampai">
                                            <input required class="span6" name="sampai" type="text" readonly="readonly" /><span class="add-on"><i class="splashy-calendar_day_up"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
