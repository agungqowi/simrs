...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
        				...
        				<li>
        					<a href="{{ action('ProjectController@index') }}">List Projects</a>
        				</li>
        				<li>
        					Create new Project
        				</li>
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Create new Project</h3>
	        		@if($errors->has())
	        		...
	        		@endif
	        		{{ Form::open(array('url' => 'project' , 'id'=>'project_form')) }}
	        			<div>
							<label>Name</label>
						...
						<div class="row-fluid formSep">
							<div class="span3">
								...
								<div class="input-append date" id="date_start">
									<input name="date_start" readonly="readonly" class="span6" type="text"/><span class="add-on"><i class="splashy-calendar_day_up"></i></span>
								</div>
							...
							<div class="span3">
								...
								<div class="input-append date" id="date_end">
									<input name="date_end" readonly="readonly" class="span6" type="text" /><span class="add-on"><i class="splashy-calendar_day_down"></i></span>
								</div>
							</div>
						</div>
						<div class="formSep">
							<label>Description</label>
							<textarea name="description" id="wysiwg_full" cols="30" rows="10"></textarea>
						</div>
