			...
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
                        ...
                        <li>
                            <a href="{{ url('swasta_transaksi') }}">Apotek</a>
                        </li>
                        <li>
                            <a href="{{ url('swasta_transaksi') }}">Swasta</a>
                        </li>
                        <li>
                            Transaksi
                        </li>
                    ...
                    <div class="row-fluid formsep">
                        <div class="span6">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="no_resep" name="no_resep" class="span6 edit-primary">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Tanggal Resep<span class="f_req">*</span></label>
                                <div class="controls">
                                    <input type="text" id="tanggal_resep" name="tanggal_resep" class="tanggal span10 edit-primary">
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" id="nama_obat" name="nama_obat" class="span5 no-primary">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="harga" name="harga" class="span5 no-primary" style="text-align: right">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Jumlah<span class="f_req">*</span></label>
                                <div class="controls">
                                    <input type="text" id="jumlah" name="jumlah" class="span3 edit-primary" style="text-align: right">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Total</label>
                                <div class="controls">
                                    <input type="text" id="total" name="total" class="span5 no-primary" style="text-align: right">
                                </div>
                            </div>
                        </div>
                        <div class="span6">
                    ...
                    <table id="tbl_obat" class="table table-striped table-bordered table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th align="center" valign="middle" class="head6">Harga</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function(){
                            oTable = $('#tbl_obat').dataTable({
                                ...
                                "sPaginationType": "full_numbers",
                                "bProcessing": false,
                                "sAjaxSource": "{{ url('swasta_obat/editdatatable') }}",
                                "bServerSide": true
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function pasien_find(val){
            $.ajax({
                url: "{{ url('swasta_transaksi/check_pasien') }}"+'/'+val,
                dataType: "json",
        ...
        function pilih_obat(id,nama,harga){
            $('#id_obat').val(id);
            $('#nama_obat').val(nama);
            $('#harga').val(harga);
        ...
        function list_transaksi(){
            ...
            $.ajax({
                url: "{{ url('swasta_transaksi/list_transaksi') }}"+'/'+no_reg,
                dataType: "json",
                success: function(res){
                    ...
                    if(res == false){
                        ...
                        $.each(res, function (key, data) {
                            $('#resep_list tbody').append('<tr><td>'+data.keluarid+'</td>'+
                                    '<td>'+data.namaobat+'</td>'+
                                    '<td>'+data.harga+'</td>'+
                                    '<td>'+data.jumlah+'</td>'+
                                    '<td>'+data.total+'</td>'+
                                    '<td><a href="javascript:void(0)" onclick="hapus_transaksi('+"'"+data.keluarid+"','"+data.kodobat+"'"+')">'+
        ...
        function tambah_transaksi(){
            ...
            $.ajax({
                url: "{{ url('swasta_transaksi/tambah_transaksi') }}",
                type: "POST",
                data : "no_reg="+no_reg+"&id_obat="+id_obat+"&jumlah="+jumlah+"&harga="+harga+"&total="+total+"&no_resep="+no_resep,
                success:function(res){
                    if(res == 'sukses'){
        ...
        function hapus_transaksi(no_resep,kode_obat){
            $.ajax({
                url: "{{ url('swasta_transaksi/hapus_transaksi') }}",
                type: "POST",
                data : "no_resep="+no_resep+"&id_obat="+kode_obat,
                success:function(res){
