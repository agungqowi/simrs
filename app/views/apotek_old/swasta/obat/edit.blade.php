...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Edit Obat Swasta
	        	...
	        	{{ Form::open( array('route' => array('swasta_obat.update', $obat->kodobat), 'method' => 'PUT' , 'class' => 'form-horizontal')) }}
                        ...
                        <div class="span12">
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <a href="{{ url('swasta_obat') }}" class="btn">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>
