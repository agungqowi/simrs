...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Edit Obat Dinas
	        	...
	        	{{ Form::open( array('route' => array('dinas_obat.update', $obat->kodobat), 'method' => 'PUT' , 'class' => 'form-horizontal')) }}
                        ...
                        <div class="span12">
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <a href="{{ url('dinas_obat') }}" class="btn">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>
