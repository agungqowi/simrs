                ...
                <div class="main_content">
					...
					<div class="row-fluid">
						<div class="span12 tac">
							<h2 class="heading" align="center">Rekap Keseluruhan</h2>
							<ul class="ov_boxes">
								<li>
								...
								<li>
									<div class="p_bar_up p_canvas"><span style="display: none;">3,3,3,3,3,3</span><canvas width="50" height="32"></canvas></div>
									<div class="ov_text">
										<strong>{{ number_format($pasien_laki) }}</strong>
										Pasien Laki-laki
									</div>
								</li>
								<li>
									<div class="p_bar_up p_canvas"><span style="display: none;">3,3,3,3,3,3</span><canvas width="50" height="32"></canvas></div>
									<div class="ov_text">
										<strong>{{ number_format($pasien_perempuan) }}</strong>
										Pasien Perempuan
									</div>
								</li>
							</ul>
							<ul class="ov_boxes">
								<li>
									<div class="p_bar_up p_canvas"><span style="display: none;">3,3,3,3,3,3</span><canvas width="50" height="32"></canvas></div>
									<div class="ov_text">
										<strong>{{ number_format($pasien_umum) }}</strong>
										Pasien Umum
									</div>
								</li>
								<li>
									<div class="p_bar_up p_canvas"><span style="display: none;">3,3,3,3,3,3</span><canvas width="50" height="32"></canvas></div>
									<div class="ov_text">
										<strong>{{ number_format($pasien_bpjs) }}</strong>
										Pasien BPJS
									</div>
								</li>
								<li>
									<div class="p_bar_up p_canvas"><span style="display: none;">3,3,3,3,3,3</span><canvas width="50" height="32"></canvas></div>
									<div class="ov_text">
										<strong>{{ number_format($pasien_penjamin) }}</strong>
										Penjamin Lainnya
									</div>
								</li>
							</ul>
							<br /><br />
							<h2 class="heading" align="center">Rekap Hari Ini</h2>
							<ul class="ov_boxes">
								<li>
					...
					<div class="row-fluid">
						<div class="span12">
							<h2 align="center" class="heading">Rekap Mingguan</h2>
						</div>
					</div>                
                    <div class="row-fluid">
                        <div class="span4">
                            <h3 class="heading">Kunjungan berdasarkan kelurahan</h3>
                        ...
                        <div class="span8">
                            <h3 class="heading">Kunjungan total pasien rawat jalan</h3>
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <h3 class="heading">Kunjungan berdasarkan cara bayar</h3>
                            <div id="fl_c" style="height:270px;width:90%;margin:15px auto 0"></div>
                        </div>
                        <div class="span6">
                            <h3 class="heading">Kunjungan berdasarkan diagnosa</h3>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <h3 class="heading">Kunjungan berdasarkan umum dan jenis kelamin</h3>
...
@section('js')
	@parent
	<script src="{{ url( 'lib/flot/jquery.flot.min.js' ) }}"></script>
    <script src="{{ url( 'lib/flot/jquery.flot.resize.min.js') }}"></script>
    <script src="{{ url( 'lib/flot/jquery.flot.pie.min.js' ) }}"></script>
    <script src="{{ url( 'lib/flot/jquery.flot.curvedLines.min.js' ) }}"></script>
    <script src="{{ url( 'lib/flot/jquery.flot.orderBars.min.js' ) }}"></script>
    <script src="{{ url( 'lib/flot/jquery.flot.multihighlight.min.js' ) }}"></script>
    <script src="{{ url( 'lib/flot/jquery.flot.pyramid.min.js' ) }}"></script>
    <script src="{{ url( 'lib/moment_js/moment.min.js' ) }}"></script>
		...
		fl_b : function() {
			...
			fl_b_plot = $.plot(elem,
			    [
					...
					{ data: exchangerates, label: " ", yaxis: 2 }
				],
				{ 
					series: {
						lines: { show: true }
            ...
            elem.on('multihighlighted', function(event, position, items){
                ...
                if(event.isTrigger) {
                    ...
                    var oilprices_label = fl_b_plot.getData()[0].label,
                        exchangerates_label = fl_b_plot.getData()[1].label,
                        oilprices_val = fl_b_plot.getData()[0].data[items[0].dataIndex],
                        exchangerates_val = fl_b_plot.getData()[1].data[items[1].dataIndex];

                    // Setup new content
                    content = date_formated + '<br/>' + oilprices_label +': '+ oilprices_val[1] +'<br/>'+ exchangerates_label +': '+ exchangerates_val[1];
        ...
        fl_e : function() {
            ...
            elem.on('plothover', function(event, pos, item) {
                ...
                if(previousPoint !== item.seriesIndex)
                {
                    ...
                    // Setup new content
                    content = item.series.label +' dengan rentang umur '+ group +' = '+ dirtyCommas(data[1]);
