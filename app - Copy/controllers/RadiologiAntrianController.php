...
class RadiologiAntrianController  extends \CrudController {
	 ...
	 * @return Response
	 */
	public $title 		= 'Antrian Pemeriksaan';
	public $table 		= 'radiologi_dataperiksa';
	public $slug 		= 'radiologi_antrian';
	public $controller 	= 'RadiologiAntrianController ';
	public $primary 	= 'id';
