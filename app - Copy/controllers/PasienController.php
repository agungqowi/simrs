...
class PasienController extends \BaseController {
	...
	public function cetakBlanko($norm){
		$pasien 	= DB::table('tbpasien')->where('NoRM' , $norm)->first();

		$txt1 = $txt2 = $txt3 = "";
		if( isset($pasien->NoRM)){
			return View::make('pasien.cetak_blanko' , array('pasien' => $pasien));
		}
		else{
			die('Data tidak ditemukan');
		}
	...
	public function cetakBlankoKosong(){
		return View::make('pasien.cetak_blanko_kosong');
	}
