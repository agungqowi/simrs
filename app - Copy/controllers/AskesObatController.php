...
class AskesObatController extends \CrudController {
	...
	public function getColumns(){
		...
		$column['het'] 				= 'HET';
		$column['harga_jual_umum'] 	= 'Harga Jual Umum';
		$column['harga_jual_asuransi'] 	= 'Harga Jual Asuransi';
		$column['harga_jual_bpjs'] 	= 'Harga Jual BPJS';
		$column['harga_jual_pt'] 	= 'Harga Jual PT';
