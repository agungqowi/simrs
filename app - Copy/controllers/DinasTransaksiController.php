...
class DinasTransaksiController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make('apotek.dinas.transaksi.create' , array('jenis_obat' => $jenis_obat));
	}
	...
	public function store()
	{
		...
		if ($validator->fails()) {
			return Redirect::to('dinas_transaksi/create')
			...
			return Redirect::to('dinas_transaksi')->with('success', 'Data Obat berhasil ditambahkan');
		}
	}
	...
	{
		$perawat = DB::table('ditransaksi')->join('tbmasukrs', 'ditransaksi.noreg', '=', 'tbmasukrs.NoReg')->join();
	...
	{
		$data = DB::table('ditransaksi')->join('diobat','ditransaksi.kodobat','=','diobat.kodobat')->where('ditransaksi.NoReg','=',$id)->get();
		return $data;
	}
	...
	public function hapus_transaksi()
	{
		...
		$data = DB::table('ditransaksi')->where('keluarid' , '=' , $no_resep)->where('kodobat' , '=' , $kode_obat)->delete();
		return $data;
	}
