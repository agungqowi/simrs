...
class SwastaSupplierController extends \CrudController {
	 ...
	 * @return Response
	 */
	public $title 		= 'Apotek Swasta Supplier';
	public $table 		= 'swsupplier';
	public $slug 		= 'swasta_supplier';
	public $controller 	= 'SwastaSupplierController';
