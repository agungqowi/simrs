...
class ApotekExpireController extends \CrudController {
	 ...
	 * @return Response
	 */
	public $title 		= 'Data Obat yang expire';
	public $table 		= 'apo_detailobat';
	public $slug 		= 'apotek_expire';
	public $controller 	= 'ApotekExpireController';
	public $primary 	= 'kodobat';
	public $table_trans = 'tbdetailobat';
	public $field_trans = 'IdObat';

	public $where 		= array( 
								 array( 'masa <= CURDATE()' ,'raw' )
						);
