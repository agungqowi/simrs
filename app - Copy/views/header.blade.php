                            ...
                            <ul class="nav user_menu pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ url('profile') }}">Ganti Password</a></li>
                                                            ...
                                                            @if(in_array($s->role , $p))
                                                                <li>
                                                                    <a href="{{ url($s->url) }}"><i class="{{ $s->icon }}"></i> 
                                                                        {{ $s->nama_menu }} 
                                                                        <?php $subs2 = DB::table('tbmenu')->where('parent' , $s->id)->where('status' , 1)->orderBy('urutan','ASC')->get(); ?>
                                                                        @if( count($subs2) > 0)
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @if( $p == 'all' || strpos($p, 'report') !== FALSE || strpos($p, 'apotik_') !== FALSE  )
                                            ...
                                            <!--
                                            <li><a href="javascript:void(0)">Laba Rugi Obat<b class="caret-right"></b></a>
                                                <ul class="dropdown-menu">
                                                    <li><a href="{{ url('report/laba_rugi_obat/apotek_askes') }}">Apotek</a></li>
                                                    <li><a href="{{ url('report/laba_rugi_obat/gudang') }}">Gudang</a></li>
                                                </ul>
                                            </li>
                                            -->
                                        @endif
