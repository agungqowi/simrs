                        ...
                        <div class="span12">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#hasiltab" data-toggle="tab">Hasil Pemeriksaan</a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="hasiltab">
                                        <h4>Hasil Pemeriksaan Radiologi</h4>
                                        <form class="form-horizontal" method="POST" action="" id="form_hasil" name="form_hasil">
                                        <input type="hidden" name="id_rad" id="id_rad" value="" />
                                        <div>
                                            <div class="control-group">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">Pilih Dokter Radiologi</label>
                                                <div class="controls">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="span12 tinymce" id="kesimpulan" name="kesimpulan"></textarea>
                                                </div>
                                            </div>
                                            <br />
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    @if(isset($id))
                                                        <?php $url_cetak = url('radiologi/cetak/'.$id); $target = "_BLANK"; ?>
                                                    @else
                        ...
                        <table id="tbl_tindakan" class="table table-striped table-bordered table-hover">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th align="center" valign="middle" class="head5">Tarif</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
@section('js')
    ...
    @include('js/radiologi')
    
    <script type="text/javascript">
    jQuery(document).ready(function($){
        $('textarea#kesimpulan').tinymce({
