    ...
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('report/bulan_inap/rincian_rawat_inap') }}">Laporan</a>
                        </li>
                        <li>
                            Rincian Rawat Inap
                        </li>
            ...
            <div id="form_content">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="heading">Rincian Laporan Rawat Inap
                        </h3>
                        ...
                        <br />
                        {{ Form::open(array('url' => 'report/bulan_inap/rincian_rawat_inap_view' ,'method' => 'POST' , 'id'=>'reg1_form', 'class' => 'form-horizontal')) }}
