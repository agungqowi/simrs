                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <span style="float:right;">
                            <a href="{{ url('report/jasa_dokter_print/rawat_inap_dokter') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
                                <i class="splashy-printer"></i> Cetak
                            </a>
                            <a href="{{ url('report/jasa_dokter_excel/rawat_inap_dokter/Excel5') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
                                <i class="splashy-calendar_week_add"></i> Excel 2003
                            </a>
                            <a href="{{ url('report/jasa_dokter_excel/rawat_inap_dokter/Excel2007') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
...
@section('js')
    ...
    <script type="text/javascript">
		...
		function detail_jasa(iddok){
			window.open("{{ url('report/jasa_dokter_detail/rawat_inap_dokter') }}/"+iddok+"?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}", "_blank");
		}
    </script>
@stop
