            ...
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('report/jasa_dokter/rawat_jalan_dokter') }}">Laporan Jasa Dokter</a>
                        </li>
                        <li>
                            Rawat Jalan
                        </li>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <span style="float:right;">
                            <a href="{{ url('report/jasa_dokter_print/rawat_jalan_dokter') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
                                <i class="splashy-printer"></i> Cetak
                            </a>
                            <a href="{{ url('report/jasa_dokter_excel/rawat_jalan_dokter/Excel5') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
                                <i class="splashy-calendar_week_add"></i> Excel 2003
                            </a>
                            <a href="{{ url('report/jasa_dokter_excel/rawat_jalan_dokter/Excel2007') }}?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}" class="btn btn-primary">
...
@section('js')
    ...
    <script type="text/javascript">
		...
		function detail_jasa(iddok){
			window.open("{{ url('report/jasa_dokter_detail/rawat_jalan_dokter') }}/"+iddok+"?dari_tanggal={{ $mulai }}&sampai_tanggal={{ $sampai }}", "_blank");
		}
    </script>
@stop
