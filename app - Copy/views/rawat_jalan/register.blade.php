                        ...
                        <div class="row-fluid formSep">
                            ...
                            <div style="width:100%;position: fixed;bottom:-10px;z-index:999;background: #FFF;padding:10px;" class="control-group formSep">
                                        <div class="controls">
                                            ...
                                            <button type="button" id="btn_cetak_blanko" class="btn btn-primary btn-cetak"><i class="splashy-printer"></i> Cetak Blanko</button>
                                            <button type="button" id="btn_cetak_blanko1" class="btn btn-primary btn-cetak"><i class="splashy-printer"></i> Cetak Blanko Kosong</button>
                                            <!--
