...
@section('content')
		...
		<div class="main_content">
	        	...
	        	<div class="span12">
	        		<h3 class="heading">Daftar Obat
                        <div style="float:right;" class="">
                            <a href="{{ URL::to('swasta_obat/create') }}" class="btn btn-success"><i class="splashy-contact_grey_add"></i> Tambah Obat Baru</a>
                        </div>
                    </h3>
	        	</div>
            </div>
            <div class="row-fluid">
                ...
                {{ Datatable::table()->addColumn('ID Obat','Nama Obat','Komposisi',
                        ...
                        ->setUrl(URL::to('swasta_obat/datatable'))->render() }}
                </div>
	        </div>
	   	</div>
	</div>
    ...
    {{ Form::open(array('url' => 'swasta_obat/', 'id' => 'delete_form', 'class' => 'pull-right')) }}
        {{ Form::hidden('_method', 'DELETE') }}
        <input type="hidden" id="url_delete" value="{{ url('swasta_obat') }}">
