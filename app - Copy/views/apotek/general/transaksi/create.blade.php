									...
									<div class="row-fluid">
										<div class="span6">
											<div align="left" id="pdf_excel" style="display:none">
												...
												<button type="button" style="display: none;" class="btn btn-success" id="cetak_etiket" ><i class="splashy-calendar_week_add"></i> Cetak Etiket</button>
											</div>  
                    	...
                    	<div style="float:right">
	                    	<table width="200px">
	                    		...
	                    		<tr>
		                    		<td>UJR</td>
		                    		<td>:</td>
		                    		<td align="right"><span id="ujr"></span></td>
	                    		</tr>
	                    		<tr>
		                    		<td>Total</td>
		                    		<td>:</td>
                    ...
                    if(res == false){
						...
						$.each(res, function (key, data) {
                            ...
                            $('#resep_list tbody').append('<tr>'+
                                    ...
                                    '<td class="align-right">'+data.Dosis+'</td>'+
                                    '<td>'+data.Apotek+'</td>'+
