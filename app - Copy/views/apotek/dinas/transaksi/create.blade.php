			...
			<nav>
        		<div id="jCrumbs" class="breadCrumb module">
        			<ul>
                        ...
                        <li>
                            <a href="{{ url('dinas_transaksi') }}">Apotek</a>
                        </li>
                        <li>
                            <a href="{{ url('dinas_transaksi') }}">Dinas</a>
                        </li>
                        <li>
                            Transaksi
                        </li>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function(){
                            oTable = $('#tbl_obat').dataTable({
                                ...
                                "sPaginationType": "full_numbers",
                                "bProcessing": false,
                                "sAjaxSource": "{{ url('dinas_obat/editdatatable') }}",
                                "bServerSide": true
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function pasien_find(val){
            $.ajax({
                url: "{{ url('dinas_transaksi/check_pasien') }}"+'/'+val,
                dataType: "json",
        ...
        function list_transaksi(){
            ...
            $.ajax({
                url: "{{ url('dinas_transaksi/list_transaksi') }}"+'/'+no_reg,
                dataType: "json",
                success: function(res){
        ...
        function tambah_transaksi(){
            ...
            $.ajax({
                url: "{{ url('dinas_transaksi/tambah_transaksi') }}",
                type: "POST",
        ...
        function hapus_transaksi(no_resep,kode_obat){
            $.ajax({
                url: "{{ url('dinas_transaksi/hapus_transaksi') }}",
                type: "POST",
