...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
	        	...
	        	<div class="span12">
                    ...
                    <div class="row-fluid">
                        <div class="span7"> 
                            ...
                            <div class="control-group">
                                <label class="control-label">No Register UGD</label>
                                <div class="controls">
                                    <input id="txt2_id_register_ugd" name="txt2_id_register_ugd" type="text" class="" disabled="disabled">
                                    <button type="button" id="btn_ugd" class="btn btn-warning" data-toggle="modal" data-target="#cari_pasien_ugd"><i class="splashy-zoom"></i> Cari</button>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Nama Lengkap</label>
            ...
            <div class="modal hide fade modal-admin" id="cari_pasien_ugd" tabindex="-1" role="dialog" aria-labelledby="cari_pasienLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="cari_pasienLabel">Pencarian Registrasi UGD</h4>
                    </div>
                    <div class="modal-body">
                       <table id="tbl_pasien_ugd" class="table table-striped table-bordered table-hover">
                            <colgroup>
                                <col class="con0" />
                                <col class="con1" />
                                <col class="con2" />
