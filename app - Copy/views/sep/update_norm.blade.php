	        	...
	        	<div class="span12">
	        		<h3 class="heading">Update Nomor SEP
                        <div class="cari-group">
                            ...
                            <button class="btn btn-warning" data-toggle="modal" data-target="#cari_ugd"><i class="splashy-zoom"></i> UGD</button>
                        </div>
                    </h3>
                       ...
                       <table id="tbl_ugd" class="table table-striped table-bordered table-hover">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th align="center" valign="middle" class="head5">Sep</th>
                                    <th align="center" valign="middle" class="head6">Gol Pasien</th>
                                    <th align="center" valign="middle" class="head7">No BPJS</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function(){
                                ...
                                oTable = jQuery('#tbl_ugd').dataTable({
                                    ...
                                    "sPaginationType": "full_numbers",
                                    "bProcessing": false,
                                    "sAjaxSource": "{{ url('ugd/popup_table_full') }}",
                                    "bServerSide": true
