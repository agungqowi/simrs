                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <span style="float:right;">
                            ...
                            <a href="{{ url('report/obat_keluar_excel/'.$slug.'/Excel5') }}?dari_tanggal={{ $dari_tanggal }}&sampai_tanggal={{ $sampai_tanggal }}" class="btn btn-primary">
                                <i class="splashy-calendar_week_add"></i> Excel 2003
                            </a>
                            <a href="{{ url('report/obat_keluar_excel/'.$slug.'/Excel2007') }}?dari_tanggal={{ $dari_tanggal }}&sampai_tanggal={{ $sampai_tanggal }}" class="btn btn-primary">
						...
						@if(count($pasien) > 0)
							<div class="row-fluid" id="printarea">
								<div class="span12">
									...
									<br />
									<h3>Laporan Obat Keluar Apotek {{$title}}</h3>
									<div>
										<table>
											<tr>
												<td>Dari Tanggal</td>
