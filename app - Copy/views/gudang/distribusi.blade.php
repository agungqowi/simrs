...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Distribusi Barang
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                   <select name="tujuan" id="tujuan">
                                        <?php $tujuan = DB::table('apo_tujuan')->get(); ?>
                                        @foreach($tujuan as $t)
                                            <option value="{{ $t->kode_tujuan }}">{{ $t->nama_tujuan }}</option>
                                        @endforeach                                       
                                   </select>
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="harga_beli" name="harga_beli" class="span8 no-primary" style="text-align: right">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Stok yang dikirim<span class="f_req">*</span></label>
                                        <div class="controls">
...
*/
        ...
        function list_transaksi(){
            ...
            if(tanggal_masuk != ''){
                $.ajax({
                    url: "{{ url('gudang_distribusi/list_transaksi/') }}",
                    dataType: "json",
                    type: "POST",
                        ...
                        if(res == false){
                            ...
                            $.each(res, function (key, data) {
                                ...
                                $('#resep_list tbody').append('<tr>'+
                                        '<td>'+data.namaobat+'</td>'+
                                        '<td>'+data.satuan+'</td>'+
                                        '<td class="align-right">'+( parseInt( data.stok ) + parseInt(data.jumlah) )+'</td>'+
        ...
        function tambah_transaksi(){
            ...
            $.ajax({
                url: "{{ url('gudang_distribusi/tambah_transaksi/'.$slug) }}",
                type: "POST",
        ...
        function hapus_transaksi(no,noba){
            ...
            if (r == true) {
                ...
                $('#pesan_error').hide();
                $.ajax({
                    url: "{{ url('gudang_distribusi/hapus_transaksi/'.$slug) }}",
                    type: "POST",
                    data : "no="+no,
                    success:function(res){
