...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Tambah Tindakan
                ...
                {{ Form::open(array('id'=>'reg1_form', 'class' => 'form-horizontal','url'=> URL::to('tindakan') )) }}
                    <div class="row-fluid formSep">
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label">Jenis Tindakan<span class="f_req">*</span></label>
                                <div class="controls">
                                    <input type="text" name="jenis_tindakan" id="jenis_tindakan" class="span10 no-primary">
                                </div>
                            </div>  
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="kelompok" id="kelompok" type="text" class="span10 no-primary">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Tarif<span class="f_req">*</span></label>
                                <div class="controls">
                                    <input name="tarif" id="tarif" type="text" class="span10 no-primary">
                                </div>
                            </div>
                        </div>
                    </div>
