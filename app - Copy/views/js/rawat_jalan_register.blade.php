	<script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $('#btn_cetak_blanko').click(function(){
                    window.open( '{{ url("pasien/blanko") }}/' + $('#txt2_no_rm').val() )
                })

                $('#btn_cetak_blanko1').click(function(){
                    window.open( '{{ url("pasien/blanko_kosong") }}')
                })
