        ...
        <div class="main_content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <form method="POST" id="user_form" name="form_user" action="">
                        <input name="_method" type="hidden" value="POST">
                        <div>
                            <label>Username</label>
                            <input disabled="disabled" type="text" name="username" id="username" value="{{ $user->username }}" />
                        </div>
                        <div>

                            <label>Password</label>
                            <input type="password" name="password" id="password" value="" />
                            <span>Biarkan kosong jika tidak ingin mengganti password</span><br />
                        </div>
                        <div>
