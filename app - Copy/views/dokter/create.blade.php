...
@section('content')
	<div id="contentwrapper">
		<div class="main_content">
        	...
        	<div class="row-fluid">
	        	<div class="span12">
	        		<h3 class="heading">Tambah Dokter
                        <div style="float:right;" class="">
                            <a href="{{ URL::to('dokter') }}" class="btn btn-warning"><i class="splashy-zoom"></i> List Dokter</a>
                        </div>
                    </h3>
	        	</div>
                {{ Form::open(array('id'=>'reg1_form', 'class' => 'form-horizontal','url'=> URL::to('dokter') )) }}
                    <div class="row-fluid formSep">
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label">Nama Lengkap<span class="f_req">*</span></label>
                                <div class="controls">
                                    <input type="text" name="txt_nama_dokter" id="txt_nama_dokter" class="span10 no-primary">
                                </div>
                            </div>
                            <div class="control-group">
                        ...
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="txt_spesialisasi" id="txt_spesialisasi" type="text" class="span10 no-primary">
                                </div>
                            </div>
                            <div class="control-group">
