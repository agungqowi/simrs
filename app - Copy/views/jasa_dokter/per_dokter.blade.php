...
@section('content')
    <div id="contentwrapper">
        <div class="main_content">
            <nav>
                <div id="jCrumbs" class="breadCrumb module">
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('jasa_dokter/dokter') }}">Pembagian Jasa</a>
                        </li>
                        <li>
                            Per Dokter
                        </li>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="heading">Pembagian Jasa per Dokter
                    </h3>

                    <div class="row-fluid">
                        <div class="span12">
                            <form action="{{ url('jasa_dokter/dokter_view') }}" method="get" class="form-horizontal" id="form_jasa">
