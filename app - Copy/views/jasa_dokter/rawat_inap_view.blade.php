                ...
                <div class="span12">
                    <h3 class="heading">Pembagian Jasa Dokter | Rawat Inap
                        <span style="float:right;">
                            <a href="{{ url('jasa_dokter/rawat_inap_print/'.$registrasi->NoReg) }}" target="_BLANK" class="btn btn-primary">
                        ...
                        <div class="span12">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    ...
                                    @if($ruangan)
                                        <tr>
                                            <td colspan="3">Biaya Ruangan</td>
                                            <td align="right">{{ number_format( $keluar->LamaTinggal * $registrasi->TarifRuangan ) }}</td>
                                        </tr>
                                        <?php 
                                            $total_ruangan = $keluar->LamaTinggal * $registrasi->TarifRuangan;
                                        ?>
                                    @endif
                                    @if(isset($tindakan))
