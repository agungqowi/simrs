...
Route::post('profile','UserController@gantiPassword');
...
Route::get('pasien/blanko/{id}' ,'PasienController@cetakBlanko');
Route::get('pasien/blanko_kosong' ,'PasienController@cetakBlankoKosong');
