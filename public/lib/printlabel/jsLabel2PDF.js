	...
	;(function($) {
		...
		*/
        ...
        $.CreateLabel = function()
		{
			 ...
			 byteArry = new Array(); 
			 pageCounter = 0;
			 pageNumbersArry = new Array();
			 fontCounter = 0;
			 fontNumbersArry = new Array();
			 pagesNumber = 0;
			 numberOfFonts = 1;  
			 numberOfPages=1;
			 outlinesNumber = 0;
			 resourcesNumber = 0;
			 catalogNumber = 0;
			 xobjectNumber = 0; //deprecated
			 xobjectNumbersArry = new Array();
	         xobjectRows = 0;
	         xobjectColumns = 0;
			
			 _textArry = new Array();
			 _textXArry = new Array();
			 _textYArry = new Array();
			 _fontSizeArry = new Array();
			 _textCounter = 0;
		...
		$.DrawPDF = function(status)
		{
			...
			window.open( 'data:application/pdf;base64,' + Base64.encode(pdfoutput) );
		};
